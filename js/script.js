...
$(document).ready(function () {
  ...
  $(document).on('click', '.descargar', function () {
    ...
    $('<div>', {
      'class': 'descarga'
    }).appendTo(el).html('<iframe class="button-api-frame" style="width:100%;height:90px;" src="https://api.download-lagu-mp3.com/@api/button/' + id + '" style="" frameborder="0" scrolling="no"></iframe>');
